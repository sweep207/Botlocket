...
TOKEN_SETS = [
    {
        "fetch_token": "appl_JngFETzdodyLmCREOlwTUtXdQik",      # Token lấy từ RevenueCat (nếu có)
        "app_transaction": "490002137599052",  # Token giao dịch Apple (nếu có)
        "is_sandbox": False         # False cho môi trường thật
    },
]
